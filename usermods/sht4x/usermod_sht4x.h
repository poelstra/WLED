...
class Sht4xUsermod : public Usermod
{
private:
...
// Strings to reduce flash memory usage (used more than twice)
const char Sht4xUsermod::_name[] PROGMEM = "SHT4x-Sensor";
const char Sht4xUsermod::_enabled[] PROGMEM = "Enabled";
const char Sht4xUsermod::_unitOfTemp[] PROGMEM = "Unit";
const char Sht4xUsermod::_haMqttDiscovery[] PROGMEM = "Add-To-HA-MQTT-Discovery";
 ...
 * @return void
 */
void Sht4xUsermod::initShtTempHumiditySensor()
{
  sensor.begin(Wire, shtI2cAddress);
  sensor.softReset();
  delay(10);
  ...
  if (error != SHT_NO_ERROR)
  {
    ...
    DEBUG_PRINTF("[%s] SHT4x init failed: %s\n", _name, errorMessage);
    cleanup();
    return;
  }
 ...
 *
 * Properly calls "reset" for the sensor.
 *
 * @return void
 */
void Sht4xUsermod::cleanupShtTempHumiditySensor()
{
  if (isShtReady())
  {
    sensor.softReset();
 ...
 *
 * Calls ::cleanupShtTempHumiditySensor() to cleanup the SHT sensor.
 *
 * @return void
 */
void Sht4xUsermod::cleanup()
{
 ...
 * @return void
 */
void Sht4xUsermod::publishTemperatureAndHumidityViaMqtt()
{
 ...
 * @return void
 */
void Sht4xUsermod::publishHomeAssistantAutodiscovery()
{
  if (!WLED_MQTT_CONNECTED)
    return;
 ...
 * @return void
 */
void Sht4xUsermod::appendDeviceToMqttDiscoveryMessage(JsonDocument &root)
{
 ...
 * @return void
 */
void Sht4xUsermod::loop()
{
  if (!enabled || !initDone || strip.isUpdating())
    return;

  if (isShtReady())
  {
    if (millis() - shtLastTimeUpdated > 30000)
    {
      int16_t error = sensor.measureLowestPrecision(shtCurrentTempC, shtCurrentHumidity);
      if (error == SHT_NO_ERROR)
      {
 ...
 * @return void
 */
void Sht4xUsermod::onMqttConnect(bool sessionPresent)
{
...
/**
 * Add dropdown for unit to UM config page.
 *
 ...
 * @return void
 */
void Sht4xUsermod::appendConfigData()
{
 ...
 * @return void
 */
void Sht4xUsermod::addToConfig(JsonObject &root)
{
 ...
 * @return bool
 */
bool Sht4xUsermod::readFromConfig(JsonObject &root)
{
 ...
 * @return void
 */
void Sht4xUsermod::addToJsonInfo(JsonObject &root)
{
 ...
 * @return float
 */
float Sht4xUsermod::getTemperature()
{
 ...
 * @return const char*
 */
const char *Sht4xUsermod::getUnitString()
{
